...
const ListofMedicinesTaken2 = () => {
    ...
    const getMedicines = async() => {
        try {
            const response = await fetch("http://localhost:5000/medicinestaken2"); // by default, fetch makes a get request
    ...
    <center><h1 class = "mt-5"> LIST OF MEDICINES TAKEN </h1></center>
    ...
    <Link to = "http://localhost:3000/medicinestaken">
...
export default ListofMedicinesTaken2;