...
const TestWiseAnalysis = () => {
    ...
    const getMedicines = async () => {
        try {
            const response = await fetch(`http://localhost:5000/testwiseanalysis?startDate=${startDate}&endDate=${endDate}`);
    ...
    return (
        <Fragment>
            <h1 id = "MedicineWiseAnalysismonthly">Test-Wise Analysis</h1>
            <h2> [Number of times test taken and revenue thereby in the specified period] </h2>
...
export default TestWiseAnalysis;
