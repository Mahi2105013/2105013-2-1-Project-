...
const ListofMedicinesTaken3 = () => {
    ...
    const getMedicines = async() => {
        try {
            const response = await fetch("http://localhost:5000/medicinestaken3"); // by default, fetch makes a get request
    ...
    <center><h1 class = "mt-5"> LIST OF MEDICINES TAKEN - page 2 </h1></center>
    ...
    <Link to = "http://localhost:3000/medicinestaken4">
...
export default ListofMedicinesTaken3;